...
Абсурд: аналогично предыдущему, но больше юмора.
Компания: уже не холодно, но ещё не жарко.
Узнать получше: буквально написанному.
451 Градус: личные вопросы и действия, однако с уважением личных границ.
"""
