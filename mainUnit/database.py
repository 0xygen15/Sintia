...
class Database:
    ...
    def create_database_if_not_exists(cls):
        try:
            ...
            logging.info("Database 'sintia' has been successfuly created!")

            connection.commit()
            connection.close()
        except psycopg2.errors.DuplicateDatabase:
            logging.info("Database 'sintia' already exists, therefore create-script skipped.")
        else:
    ...
    def create_users_table(cls):
        ...
        logging.info("Table 'users' was successfully created in database 'sintia'!")
    ...
    def add_user_to_db(cls, users_obj: Users):
        ...
        try:
            ...
            logging.info(f"[INFO] Method {cls.add_user_to_db.__name__} has executed SELECT query.")
            ...
            logging.debug(f"Method {cls.add_user_to_db.__name__} has executed INSERT query.")
            ...
            user_objects[user_id] = users_obj  # ADD OBJECT TO OBJECT DICT
            logging.debug(f"Method {cls.add_user_to_db.__name__} has added object to object dict.")
            connection.close()
