...
async def main():
    ...
    await translate2l('ru', 'en', './database/dare.json', './database/uk/dare.json', 'google')
    await translate2l('ru', 'en', './database/truth.json', './database/uk/truth.json', 'google')
    await translate2l('ru', 'en', './database/never.json', './database/uk/never.json', 'google')
