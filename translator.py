...
# from mainUnit.engine import Texts, Users
#
# the_id = 107985053
#
# Users.change_user_lang_code('en', the_id)
# print("Lang code changed to EN")
# Texts.lang_code = Users.get_user_lang_code(the_id)
# print("That would be new lang code below")
# print(Texts.lang_code)
